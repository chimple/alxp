...
oneway interface IContactListListener {
     ...
     *  </ul>
     *
     * @see org.chimple.messenger.engine.ContactListListener#onContactChange(int, ContactList, Contact)
     */
     ...
     *
     * @see org.chimple.messenger.engine.ContactListListener#onAllContactListsLoaded()
     */
     ...
     *
     * @see org.chimple.messenger.engine.ContactListListener#onContactsPresenceUpdate(Contact[])
     */
     ...
     *
     * @see org.chimple.messenger.engine.ContactListListener#onContactError(int, ImErrorInfo, String, Contact)
     */
