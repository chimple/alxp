...
interface IChatListener {
     ...
     */
    boolean onIncomingMessage(IChatSession ses, in org.chimple.messenger.model.Message msg);
     ...
     */
    void onSendMessageError(IChatSession ses, in org.chimple.messenger.model.Message msg, in ImErrorInfo error);
