...
package org.chimple.messenger.provider;
...
public class Imps {
    ...
    public static final class Provider implements BaseColumns, ProviderColumns {
        ...
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/providers");

        public static final Uri CONTENT_URI_WITH_ACCOUNT = Uri
                .parse("content://org.chimple.messenger.provider.Imps/providers/account");
    ...
    public static final class Word implements BaseColumns, WordColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/words");
    ...
    public static final class Phonic implements BaseColumns, PhonicColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/phonics");
    ...
    public static final class PhonicsList implements BaseColumns, PhonicsListColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/phonicsList");
    ...
    public static final class Account implements BaseColumns, AccountColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/accounts");

        /** The content:// style URL for looking up by domain */
        public static final Uri BY_DOMAIN_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/domainAccounts");
    ...
    public static final class AccountStatus implements BaseColumns, AccountStatusColumns {
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/accountStatus");
    ...
    public static final class Contacts implements BaseColumns, ContactsColumns, PresenceColumns,
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/contacts");

        /** The content:// style URL for contacts joined with presence */
        public static final Uri CONTENT_URI_WITH_PRESENCE = Uri
                .parse("content://org.chimple.messenger.provider.Imps/contactsWithPresence");
        ...
        public static final Uri CONTENT_URI_ONLINE_CONTACTS_BY = Uri
                .parse("content://org.chimple.messenger.provider.Imps/contacts/online");
        ...
        public static final Uri CONTENT_URI_OFFLINE_CONTACTS_BY = Uri
                .parse("content://org.chimple.messenger.provider.Imps/contacts/offline");

        /** The content:// style URL for operations on bulk contacts */
        public static final Uri BULK_CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/bulk_contacts");
        ...
        public static final Uri CONTENT_URI_ONLINE_COUNT = Uri
                .parse("content://org.chimple.messenger.provider.Imps/contacts/onlineCount");
    ...
    public static final class ContactList implements BaseColumns, ContactListColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/contactLists");
    ...
    public static final class BlockedList implements BaseColumns, BlockedListColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/blockedList");
    ...
    public static final class ContactsEtag implements BaseColumns, ContactsEtagColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/contactsEtag");
    ...
    public static final class Messages implements BaseColumns, MessageColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/messages");

        /** The content:// style URL for messages by thread id */
        public static final Uri CONTENT_URI_MESSAGES_BY_THREAD_ID = Uri
                .parse("content://org.chimple.messenger.provider.Imps/messagesByThreadId");

        /** The content:// style URL for messages by thread id */
        public static final Uri CONTENT_URI_MESSAGES_BY_PACKET_ID = Uri
                .parse("content://org.chimple.messenger.provider.Imps/messagesByPacketId");
        ...
        public static final Uri OTR_MESSAGES_CONTENT_URI_BY_THREAD_ID = Uri
                .parse("content://org.chimple.messenger.provider.Imps/otrMessagesByThreadId");
        ...
        public static final Uri OTR_MESSAGES_CONTENT_URI_BY_ACCOUNT_AND_CONTACT = Uri
                .parse("content://org.chimple.messenger.provider.Imps/otrMessagesByAcctAndContact");
        ...
        public static final Uri OTR_MESSAGES_CONTENT_URI_BY_PROVIDER = Uri
                .parse("content://org.chimple.messenger.provider.Imps/otrMessagesByProvider");
        ...
        public static final Uri OTR_MESSAGES_CONTENT_URI_BY_ACCOUNT = Uri
                .parse("content://org.chimple.messenger.provider.Imps/otrMessagesByAccount");

        public static final Uri OTR_MESSAGES_CONTENT_URI_BY_PACKET_ID = Uri
                .parse("content://org.chimple.messenger.provider.Imps/otrMessagesByPacketId");
    ...
    public final static class GroupMembers implements GroupMemberColumns {
        ...
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/groupMembers");
    ...
    public final static class Invitation implements InvitationColumns, BaseColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/invitations");
    ...
    public static final class Avatars implements BaseColumns, AvatarsColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/avatars");

        /**
         * The content:// style URL for avatars by provider, account and contact
         */
        public static final Uri CONTENT_URI_AVATARS_BY = Uri
                .parse("content://org.chimple.messenger.provider.Imps/avatarsBy");
    ...
    public static final class Presence implements BaseColumns, PresenceColumns {
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/presence");

        /** The content URL for IM presences for an account */
        public static final Uri CONTENT_URI_BY_ACCOUNT = Uri
                .parse("content://org.chimple.messenger.provider.Imps/presence/account");

        /** The content:// style URL for operations on bulk contacts */
        public static final Uri BULK_CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/bulk_presence");
        ...
        public static final Uri SEED_PRESENCE_BY_ACCOUNT_CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/seed_presence/account");
    ...
    public static final class Chats implements BaseColumns, ChatsColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/chats");

        /** The content URL for all chats that belong to the account */
        public static final Uri CONTENT_URI_BY_ACCOUNT = Uri
                .parse("content://org.chimple.messenger.provider.Imps/chats/account");
    ...
    public static class SessionCookies implements SessionCookiesColumns, BaseColumns {
        ...
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/sessionCookies");
        ...
        public static final Uri CONTENT_URI_SESSION_COOKIES_BY = Uri
                .parse("content://org.chimple.messenger.provider.Imps/sessionCookiesBy");
    ...
    public static class ProviderSettings implements ProviderSettingsColumns {
        ...
        /** The content:// style URI for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/providerSettings");
    ...
    public static final class BrandingResourceMapCache implements BaseColumns,
        ...
        /** The content:// style URL for this table. */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/brandingResMapCache");
    }
    ...
    public static final class OutgoingRmq implements BaseColumns, OutgoingRmqColumns {
        ...
        /** The content:// style URL for this table. */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/outgoingRmqMessages");
        ...
        public static final Uri CONTENT_URI_FOR_HIGHEST_RMQ_ID = Uri
                .parse("content://org.chimple.messenger.provider.Imps/outgoingHighestRmqId");
    ...
    public static final class LastRmqId implements BaseColumns, LastRmqIdColumns {
        ...
        /** The content:// style URL for this table. */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/lastRmqId");
    }
    ...
    public static final class ServerToDeviceRmqIds implements BaseColumns,
        ...
        /** The content:// style URL for this table. */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.chimple.messenger.provider.Imps/s2dids");
    }
