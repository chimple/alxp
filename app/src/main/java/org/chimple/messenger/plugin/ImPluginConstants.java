 ...
 * the License.
 */
package org.chimple.messenger.plugin;

public class ImPluginConstants {

    /** The intent action name for the plugin service. */
    public static final String PLUGIN_ACTION_NAME = "org.chimple.messenger.plugin";

    /**
     * The name of the provider. It should match the values defined in
     * {@link org.chimple.messenger.provider.Imps.ProviderNames}.
     */
