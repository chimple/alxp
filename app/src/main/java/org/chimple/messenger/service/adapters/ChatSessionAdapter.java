...
import org.chimple.messenger.crypto.OtrChatListener;
import org.chimple.messenger.crypto.OtrChatManager;
import org.chimple.messenger.crypto.OtrChatSessionAdapter;
import org.chimple.messenger.crypto.OtrDataHandler;
import org.chimple.messenger.crypto.OtrDataHandler.Transfer;
...
import org.chimple.messenger.model.GroupMemberListener;
...
import org.chimple.messenger.plugin.loopback.NonOtrChatListener;
import org.chimple.messenger.plugin.xmpp.XmppAddress;
import org.chimple.messenger.provider.Imps;
import org.chimple.messenger.service.IChatListener;
import org.chimple.messenger.service.IDataListener;
import org.chimple.messenger.service.RemoteImService;
import org.chimple.messenger.service.StatusBarNotifier;
import org.chimple.messenger.util.SystemServices;
...
public class ChatSessionAdapter extends org.chimple.messenger.service.IChatSession.Stub {
    ...
    public void sendMessage(String text, boolean isResend) {
        ...
        org.chimple.messenger.model.Message msg = new org.chimple.messenger.model.Message(text);
        msg.setID(nextID());
...
*/
    ...
    private void copyHistoryMessages(Contact oldParticipant) {
        List<org.chimple.messenger.model.Message> historyMessages = mChatSession.getHistoryMessages();
        int total = historyMessages.size();
        int start = total > MAX_HISTORY_COPY_COUNT ? total - MAX_HISTORY_COPY_COUNT : 0;
        for (int i = start; i < total; i++) {
            org.chimple.messenger.model.Message msg = historyMessages.get(i);
    ...
    class ListenerAdapter implements MessageListener, GroupMemberListener, OtrEngineListener {
        ...
        public synchronized boolean onIncomingMessage(ChatSession ses, final org.chimple.messenger.model.Message msg) {
        ...
        public void onSendMessageError(ChatSession ses, final org.chimple.messenger.model.Message msg, final ImErrorInfo error) {
        ...
        @Override
        public void onIncomingDataRequest(ChatSession session, org.chimple.messenger.model.Message msg, byte[] value) {
            mDataHandler.onIncomingRequest(msg.getFrom(),msg.getTo(), value);
        }

        @Override
        public void onIncomingDataResponse(ChatSession session, org.chimple.messenger.model.Message msg, byte[] value) {
    ...
    public boolean sendPushWhitelistToken(@NonNull String token) {
        ...
        org.chimple.messenger.model.Message msg = new org.chimple.messenger.model.Message("");
